        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <div class="card">
                <div class="card-body">
                  <h1 class="card-title">Kepuasan terhadap Layanan Data dan Informasi Statistik BPS</h1>
                  <p class="card-text">
              ...
              <form>
                        ...
                        <div class="col-12 col-md-6">
                          <div class="d-flex justify-content-end">
                            <div class="p-2">
                              ...
                              <input type="number" class="form-control" id="kepuasan" name="kepuasan" min="1" max="10" style="width: 100px;">
                            </div>
                            <div class="p-2">
                              <label for="kepentingan" class="form-label">Tingkat Kepentingan</label>
                              <input type="number" class="form-control" id="kepentingan" name="kepentingan" min="1" max="10" style="width: 100px;">
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <a type="button" href="<?= base_url('/form1'); ?>" class="btn btn-primary">Kembali</a>
