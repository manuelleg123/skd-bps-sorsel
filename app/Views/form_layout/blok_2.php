<div class="step" id="step2">
        ...
        <div class="mb-1 row d-flex justify-content-between">
            ...
            <div class="col-12 col-md-6">
                <div class="d-flex justify-content-end flex-wrap flex-md-nowrap">
                    <!-- Rating Kepentingan -->
                    <div class="flex-fill flex-md-unset">
                        <label class="form-label fw-bold">
                            Tingkat Kepentingan <small class="text-muted">(harapan konsumen)</small>
                            <i class="bi bi-info-circle" data-bs-toggle="tooltip" title="Seberapa penting aspek ini bagi Anda?"></i>
                        </label>
                        <div class="rating-wrapper d-flex flex-wrap align-items-center gap-2">
                            <div class="rating d-flex gap-1 flex-wrap" data-name="kepentingan[0]"></div>
                            <span class="badge selected-value bg-light text-dark border border-secondary">-</span>
                        </div>
                    </div>
                    <!-- Rating Kepuasan -->
                    <div class="flex-fill flex-md-unset">
                        <label class="form-label fw-bold">
                            Tingkat Kepuasan <small class="text-muted">(penilaian konsumen)</small>
                            <i class="bi bi-info-circle" data-bs-toggle="tooltip" title="Seberapa puas Anda terhadap pelayanan kami pada aspek ini?"></i>
                        </label>
                        <div class="rating-wrapper d-flex flex-wrap align-items-center gap-2">
                            <div class="rating d-flex gap-1 flex-wrap" data-name="kepuasan[0]"></div>
                            <span class="badge selected-value bg-light text-dark border border-secondary">-</span>
                        </div>
                        <div class="form-text text-danger d-none">Pilih tingkat kepuasan.</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="mb-1 row d-flex justify-content-between">
            <label class="col-12 col-md-6 p-2 form-label">
            ...
            <div class="col-12 col-md-6">
                <div class="d-flex justify-content-end flex-wrap flex-md-nowrap">
                    ...
                    <div class="flex-fill flex-md-unset">
                        ...
                        <div class="rating-wrapper d-flex flex-wrap align-items-center gap-2">
                            <div class="rating d-flex gap-1 flex-wrap" data-name="kepentingan[1]"></div>
                            <span class="badge selected-value bg-light text-dark border border-secondary">-</span>
                        </div>
                    </div>
                    <!-- Rating Kepuasan -->
                    <div class="flex-fill flex-md-unset">
                        ...
                        <div class="rating-wrapper d-flex flex-wrap align-items-center gap-2">
                            <div class="rating d-flex gap-1 flex-wrap" data-name="kepuasan[1]"></div>
                            <span class="badge selected-value bg-light text-dark border border-secondary">-</span>
                        </div>
                        <div class="form-text text-danger d-none">Pilih tingkat kepuasan.</div>
                    </div>
            ...
            <div class="col-12 col-md-6">
                <div class="d-flex justify-content-end flex-wrap flex-md-nowrap">
                    ...
                    <div class="flex-fill flex-md-unset">
                        ...
                        <div class="rating-wrapper d-flex flex-wrap align-items-center gap-2">
                            <div class="rating d-flex gap-1 flex-wrap" data-name="kepentingan[2]"></div>
                            <span class="badge selected-value bg-light text-dark border border-secondary">-</span>
                        </div>
                    </div>
                    <!-- Rating Kepuasan -->
                    <div class="flex-fill flex-md-unset">
                        ...
                        <div class="rating-wrapper d-flex flex-wrap align-items-center gap-2">
                            <div class="rating d-flex gap-1 flex-wrap" data-name="kepuasan[2]"></div>
                            <span class="badge selected-value bg-light text-dark border border-secondary">-</span>
                        </div>
                        <div class="form-text text-danger d-none">Pilih tingkat kepuasan.</div>
                    </div>
            ...
            <div class="col-12 col-md-6">
                <div class="d-flex justify-content-end flex-wrap flex-md-nowrap">
                    ...
                    <div class="flex-fill flex-md-unset">
                        ...
                        <div class="rating-wrapper d-flex flex-wrap align-items-center gap-2">
                            <div class="rating d-flex gap-1 flex-wrap" data-name="kepentingan[3]"></div>
                            <span class="badge selected-value bg-light text-dark border border-secondary">-</span>
                        </div>
                    </div>
                    <!-- Rating Kepuasan -->
                    <div class="flex-fill flex-md-unset">
                        ...
                        <div class="rating-wrapper d-flex flex-wrap align-items-center gap-2">
                            <div class="rating d-flex gap-1 flex-wrap" data-name="kepuasan[3]"></div>
                            <span class="badge selected-value bg-light text-dark border border-secondary">-</span>
                        </div>
                        <div class="form-text text-danger d-none">Pilih tingkat kepuasan.</div>
                    </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="container">
                <div class="mb-1 row d-flex justify-content-between">
                    <div class="col-12 col-md-6 p-2">
                        <label for="nama" class="form-label">11. Keberadaan fasilitas pengaduan PST mudah diketahui.</label>
                        <p><small>(contoh: Kotak saran dan pengaduan, website <a href="https://webapps.bps.go.id/pengaduan">https://webapps.bps.go.id/pengaduan</a>, <i>e-mail</i> <a href="mailto:bpshq@bps.go.id">bpshq@bps.go.id</a>)</small></p>
                    </div>
                    <div class="col-12 col-md-6 p-2">
                        <div class="d-flex justify-content-end">
                            <div class="p-1">
            ...
            <div class="container">
                <div class="mb-1 row d-flex justify-content-between">
                    <div class="col-12 col-md-6 p-2">
                        ...
                        <p><small><a href="http://s.bps.go.id/pppnbp" target="_blank" rel="noopener noreferrer">PP nomor 13 tahun 2024 tentang PNBP</a> dan <a href="https://ppid.bps.go.id/upload/doc/Peraturan_Badan_Pusat_Statistik_No__2_Tahun_2019_tentang_Persyaratan_dan_Tata_Cara_Pengenaan_Tarif_Rp0_00__nol_rupiah__1646715329.pdf">PerBan No-2-Tahun-2019 ttg tarif nol rupiah</a></small></p>
                    </div>
                    <div class="col-12 col-md-6 p-2">
                        <div class="d-flex justify-content-end">
                            <div class="p-1">
